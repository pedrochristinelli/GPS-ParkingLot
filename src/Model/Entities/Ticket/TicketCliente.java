...
public class TicketCliente extends Ticket {
    ...
    public TicketCliente(String placa, String telefone, Date horarioEntrada, Date horarioSaida, String descricaoCarro, double valorTotal, double valorNoite, boolean isPernoite) {
        super(placa, horarioEntrada, horarioSaida, descricaoCarro);
    ...
    public TicketCliente(String placa, Date horarioEntrada, Date horarioSaida, String descricaoCarro) {
        super(placa, horarioEntrada, horarioSaida, descricaoCarro);
    }
